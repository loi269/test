...
export default function AdminKhachHang() {
  ...
  useEffect(() => {
    const detail = async () => {
      try {
        const res = await customerService.detailUserById(id);
          ...
          validationSchema={Yup.object({
            name: Yup.string()
              ...
              .matches(
                ...
                "Tên phải đúng định dạng. VD: Nguyễn Văn A"
              )
            ...
            dateOfBirth: Yup.date()
              ...
              .max(
                getMinDate(),
                "Người dùng đăng ký tài khoản phải từ 15 tuổi trở lên"
              ),
            ...
            phoneNumber: Yup.string()
              ...
              .matches(
                ...
                "Nhập đúng định dạng SDT VD: 0903.XXX.XXX (X là chữ số)"
              ),
            ...
            const editCustomer = async () => {
              try {
                if (isChangeImg) {
                  ...
                  await customerService.updateUserById(newValues);
                } else {
                  await customerService.updateUserById(value);
              ...
              >
                <div className="row mx-0 mt-5 p-5 ">
                  <div>
                    <NavLink
                      to={"/"}
                      className="bi bi-house text-secondary fs-4 text-decoration-none"
                    >
                    ...
                    <div className="row">
                        ...
                        <div className="position-relative">
                          {avatarErr ? (
                            <div>
                              <h5
                                ...
                                height="100%"
                              >
                                Sai định dạng ảnh, phải có dạng đuôi .jpg,
                                .jpeg, .png
                              </h5>
                            </div>
                          ) : (
                          ...
                          <div className={!avatarErr && "border-camera"}>
                            <label
                              htmlFor="avatar"
                              type="button"
                              className="bi bi-camera-fill fs-2"
                            ></label>
                            <input
                              type="file"
                      ...
                      <div className="col-9">
                        <div className="row ms-3 px-3">
                          <h2 className="text-center text-secondary bg-home py-2">
                                ...
                                <div className="col-6">
                                  <div className="form-group mt-2">
                                    ...
                                    <div className="input-field-1">
                                      <span className="input-login text-danger fw-bold">
                                        {customerDetail?.code}
                                      </span>
                                    </div>
                                  </div>
                                  ...
                                  <div className="form-group mt-2">
                                    ...
                                    <div className="mt-2">
                                      <div className="form-check form-check-inline ">
                                        ...
                                        />
                                        <label
                                          className="form-check-label text-register"
                                ...
                                {isSubmitting ? (
                                  ...
                                  <div className="d-flex justify-content-center mt-4">
                                    <NavLink
                                      ...
                                      className="button-buy text-decoration-none text-center mx-2"
                                    >
                                      Quay lại
                                    </NavLink>
                                    <button
                                      type={avatarErr ? "button" : "submit"}
                                      className="button-buy text-center ms-3"
                                    >
                                      Xác nhận
                                    </button>
                                  </div>
